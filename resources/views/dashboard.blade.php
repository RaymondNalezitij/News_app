                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div style="display: flex; flex-direction: row">
                        ...
                        <select name="category" id="category">
                            <option onselect="sortByCategory(1)" value="all">All</option>
                            @foreach($categories as $category)
                                @if($category->id > 1)
                                    <option onselect="sortByCategory({{ $category->id }})" value="{{ $category->name }}">{{ $category->name }}</option>
                                @endif
                            @endforeach
                        </select>
                                        ...
                                        <div style="display: flex; flex-direction: row; justify-content: space-between">
                                            ...
                                            <form action="{{ route('dashboard.store') }}" method="POST">
                                                ...
                                                <div style="display: flex;flex-direction: column">
                                                    <select name="category" id="category" style="max-height: 40px">
                                                        ...
                                                        @if(count($admin_status) > 0)
                                                            @if($admin_status[0]->is_admin_at == 'global' || $admin_status[0]->is_admin_at == 'dashboard')
                                                                ...
                                                                <label for="commentId{{ $comment->id }}">
                                                                    <input name="commentId" id="commentId{{ $comment->id }}"
